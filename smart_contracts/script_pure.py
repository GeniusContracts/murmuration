...
class CommunityFund(sp.Contract):
    def __init__(
      ...
      governorAddress = Addresses.GOVERNOR_ADDRESS
        ...
        metadata_data = sp.utils.bytes_of_string('{ "name": "SalsaDAO Treasury", "description": "Token Repository for SalsaDAO", "authors": ["Genius Contracts"], "homepage":  "https://salsadao.xyz" }')
